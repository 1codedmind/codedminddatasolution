...
export default function ModernPreview({ data, color }: Props) {
  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", background: "#fff", width: "100%", minHeight: "100%", padding: "32px 36px", boxSizing: "border-box" }}>
      {/* Header */}
