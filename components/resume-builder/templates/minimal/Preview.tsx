...
export default function MinimalPreview({ data, color }: Props) {
  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", background: "#fff", width: "100%", minHeight: "100%", padding: "40px 44px", boxSizing: "border-box" }}>
      {/* Header */}
