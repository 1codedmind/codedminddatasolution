  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-extrabold text-stone-900 tracking-tight mt-3">Timestamp Converter</h1>
        <p className="text-stone-500 mt-1">Convert Unix timestamps to readable dates and back.</p>
      </div>
